...
import { IconButton, Box, Typography, Flex, Loader, LinkButton, Table, Thead, Tr, Th, Tbody, Td, Modal, Button, TextInput, Textarea, SingleSelect, SingleSelectOption } from "@strapi/design-system";
import { P as PLUGIN_ID } from "./index-Bix5BoJU.mjs";
...
import { Plus, Trash, Cross, Upload, Loader as Loader$1, Check } from "@strapi/icons";
...
const LoaderComponent = () => {
  return /* @__PURE__ */ jsx(
    Flex,
    {
      ...
      alignItems: "center",
      style: { height: "80vh" },
      children: /* @__PURE__ */ jsx(Loader, { style: { width: 42, height: 42 } })
    }
  );
};
const ContributorsPage = () => {
  ...
  const fetchArticles = async () => {
    setLoading(true);
    const articles2 = await fetch("/submissions2/contributers/allArticles", {
      method: "GET",
      headers: {
        "Content-Type": "application/json"
      }
    });
    const data = await articles2.json();
    setArticles(data);
    setLoading(false);
  };
  useEffect(() => {
        ...
        return /* @__PURE__ */ jsxs(Flex, { gap: 2, children: [
          /* @__PURE__ */ jsx(
            TooltipIconButton,
            {
              ...
              label: "Submit",
              variant: "success",
              children: actionLoading.id === article.id && actionLoading.type === "submit" ? /* @__PURE__ */ jsx(Loader, {}) : /* @__PURE__ */ jsx(Upload, {})
            }
          ),
          /* @__PURE__ */ jsx(
            TooltipIconButton,
            {
              ...
              label: "Delete",
              variant: "danger",
              children: actionLoading.id === article.id && actionLoading.type === "delete" ? /* @__PURE__ */ jsx(Loader, {}) : /* @__PURE__ */ jsx(Trash, {})
            }
          )
        ] });
      case "submitted":
  ...
  return /* @__PURE__ */ jsxs(Fragment$1, { children: [
    /* @__PURE__ */ jsxs(Flex, { justifyContent: "space-between", alignItems: "center", padding: 6, maxWidth: "100%", children: [
      /* @__PURE__ */ jsx(Typography, { variant: "alpha", fontWeight: "bold", children: "Contributor Articles" }),
      /* @__PURE__ */ jsx(
        LinkButton,
        {
    ...
    /* @__PURE__ */ jsx(Box, { padding: 6, background: "neutral100", children: loading ? /* @__PURE__ */ jsx(LoaderComponent, {}) : (
      // <Box
      //   style={{
      //     width: '100%',
      //     maxWidth: '1350px',
      ...
      //   }}
      // >
      /* @__PURE__ */ jsxs(Table, { colCount: 6, rowCount: articles.length, children: [
        /* @__PURE__ */ jsx(Thead, { children: /* @__PURE__ */ jsxs(Tr, { children: [
          ...
          /* @__PURE__ */ jsx(Th, { children: /* @__PURE__ */ jsx(Typography, { variant: "sigma", children: "Author" }) }),
          /* @__PURE__ */ jsx(Th, { children: /* @__PURE__ */ jsx(Typography, { variant: "sigma", children: "Category" }) }),
          /* @__PURE__ */ jsx(Th, { children: /* @__PURE__ */ jsx(Typography, { variant: "sigma", children: "Submission Status" }) }),
        ...
        /* @__PURE__ */ jsx(Tbody, { children: articles.map((article) => /* @__PURE__ */ jsxs(Tr, { children: [
          /* @__PURE__ */ jsx(Td, { children: /* @__PURE__ */ jsx(Typography, { textColor: "neutral800", children: article.title }) }),
          /* @__PURE__ */ jsx(Td, { children: /* @__PURE__ */ jsx(Typography, { textColor: "neutral800", children: article.description.length > 50 ? `${article.description.substring(0, 50)}...` : article.description }) }),
          /* @__PURE__ */ jsx(Td, { children: /* @__PURE__ */ jsx(Typography, { textColor: "neutral800", children: article.author.name }) }),
          /* @__PURE__ */ jsx(Td, { children: /* @__PURE__ */ jsx(Typography, { textColor: "neutral800", children: article.category.name }) }),
          /* @__PURE__ */ jsx(Td, { children: /* @__PURE__ */ jsx(
            Typography,
            {
              ...
              children: article?.submissionStatus
            }
          ) }),
          /* @__PURE__ */ jsx(Td, { children: /* @__PURE__ */ jsx(Typography, { textColor: "neutral800", children: new Date(article.createdAt).toLocaleDateString() }) }),
          /* @__PURE__ */ jsx(Td, { children: /* @__PURE__ */ jsx(Flex, { gap: 2, children: renderActionButtons(article) }) })
        ] }, article.id)) })
      ] })
    ) }),
    /* @__PURE__ */ jsx(Modal.Root, { open: isModalOpen, onOpenChange: setIsModalOpen, children: /* @__PURE__ */ jsxs(Modal.Content, { children: [
      /* @__PURE__ */ jsx(Modal.Header, { children: /* @__PURE__ */ jsx(Modal.Title, { children: "Delete Article" }) }),
      /* @__PURE__ */ jsx(Modal.Body, { children: /* @__PURE__ */ jsx(Typography, { children: "Are you sure you want to delete this article?" }) }),
      /* @__PURE__ */ jsxs(Modal.Footer, { children: [
        /* @__PURE__ */ jsx(Modal.Close, { children: /* @__PURE__ */ jsx(Button, { variant: "tertiary", children: "Cancel" }) }),
        /* @__PURE__ */ jsx(Button, { variant: "danger", onClick: confirmDelete, children: "Confirm" })
      ] })
    ] }) })
  ] });
};
const EditorsPage = () => {
  ...
  const fetchArticles = async () => {
    setLoading(true);
    const articles2 = await fetch("/submissions2/editors/articles", {
      method: "GET",
      headers: {
        "Content-Type": "application/json"
      }
      ...
      return /* @__PURE__ */ jsxs(Flex, { gap: 2, children: [
        /* @__PURE__ */ jsx(
          TooltipIconButton,
          {
            ...
            label: "Approve",
            variant: "success",
            children: actionLoading.id === article.id && actionLoading.type === "approve" ? /* @__PURE__ */ jsx(Loader$1, {}) : /* @__PURE__ */ jsx(Check, {})
          }
        ),
        /* @__PURE__ */ jsx(
          TooltipIconButton,
          {
            ...
            label: "Reject",
            variant: "danger",
            children: actionLoading.id === article.id && actionLoading.type === "reject" ? /* @__PURE__ */ jsx(Loader$1, {}) : /* @__PURE__ */ jsx(Cross, {})
          }
        )
      ] });
    }
  ...
  return /* @__PURE__ */ jsx(Fragment$1, { children: loading ? /* @__PURE__ */ jsx(LoaderComponent, {}) : /* @__PURE__ */ jsxs(Fragment$1, { children: [
    /* @__PURE__ */ jsx(Box, { padding: 8, background: "neutral100", overflowX: "auto", paddingBottom: 0, children: /* @__PURE__ */ jsx(Typography, { variant: "alpha", fontWeight: "bold", children: "Editors Panel" }) }),
    /* @__PURE__ */ jsx(Box, { padding: 8, background: "neutral100", overflowX: "auto", children: /* @__PURE__ */ jsxs(Table, { colCount: 6, rowCount: articles.length, children: [
      /* @__PURE__ */ jsx(Thead, { children: /* @__PURE__ */ jsxs(Tr, { children: [
      ...
      /* @__PURE__ */ jsx(Tbody, { children: articles.map((article) => /* @__PURE__ */ jsxs(Tr, { children: [
        /* @__PURE__ */ jsx(Td, { children: /* @__PURE__ */ jsx(Typography, { textColor: "neutral800", children: article.id }) }),
        /* @__PURE__ */ jsx(Td, { children: /* @__PURE__ */ jsx(Typography, { textColor: "neutral800", children: article.title }) }),
        /* @__PURE__ */ jsx(Td, { children: /* @__PURE__ */ jsx(Typography, { textColor: "neutral800", children: truncateText(article.description) }) }),
        /* @__PURE__ */ jsx(Td, { children: /* @__PURE__ */ jsx(Typography, { textColor: "neutral800", children: article.slug }) }),
        /* @__PURE__ */ jsx(Td, { children: /* @__PURE__ */ jsx(
          Typography,
          {
            textColor: getStatusColor(article?.submissionStatus),
        ...
        /* @__PURE__ */ jsx(Td, { children: renderActionButtons(article) })
      ] }, article.id)) })
    ] }) })
  ] }) });
};
...
const HomePage = () => {
  ...
  const renderContent = () => {
    if (currentPath === `/plugins/${PLUGIN_ID}/contributors`) {
      return /* @__PURE__ */ jsx(ContributorsPage, {});
    }
    if (currentPath === `/plugins/${PLUGIN_ID}/editors`) {
      return /* @__PURE__ */ jsx(EditorsPage, {});
    }
    return /* @__PURE__ */ jsxs(Box, { background: "neutral0", padding: 4, shadow: "filterShadow", hasRadius: true, children: [
      /* @__PURE__ */ jsx(Typography, { variant: "beta", children: "Welcome to Submissions Plugin" }),
      /* @__PURE__ */ jsx(Box, { paddingTop: 4, children: /* @__PURE__ */ jsx(Typography, { variant: "omega", children: "Use the navigation links above to manage your contributors and editors." }) })
    ] });
  };
  return /* @__PURE__ */ jsxs(Box, { background: "neutral100", padding: 8, children: [
    /* @__PURE__ */ jsx(Box, { paddingBottom: 4, children: /* @__PURE__ */ jsx(Typography, { variant: "alpha", children: "Submissions" }) }),
    /* @__PURE__ */ jsx(Box, { paddingBottom: 4, children: /* @__PURE__ */ jsx("nav", { children: /* @__PURE__ */ jsxs(Flex, { gap: 4, children: [
      /* @__PURE__ */ jsx(
        StyledNavLink,
        {
...
const AddArticle = () => {
  ...
  return /* @__PURE__ */ jsxs(Box, { padding: 8, background: "neutral100", children: [
    /* @__PURE__ */ jsx(Typography, { variant: "alpha", fontWeight: "bold", marginBottom: 10, children: "Add New Article" }),
    /* @__PURE__ */ jsx(FormBox, { children: /* @__PURE__ */ jsxs("form", { onSubmit: (e) => handleSubmit(e), children: [
      /* @__PURE__ */ jsxs(Box, { marginBottom: 4, marginTop: 5, children: [
        ...
        /* @__PURE__ */ jsx(FieldHint, { children: "A clear and descriptive title for your article" })
      ] }),
      /* @__PURE__ */ jsxs(Box, { marginBottom: 4, children: [
        ...
        /* @__PURE__ */ jsx(FieldHint, { children: "Provide a comprehensive description of your article's content" })
      ] }),
      /* @__PURE__ */ jsxs(Box, { marginBottom: 4, children: [
        /* @__PURE__ */ jsx(FieldLabel, { children: "Author" }),
        /* @__PURE__ */ jsxs(
          SingleSelect,
          {
            ...
            required: true,
            children: [
              /* @__PURE__ */ jsx(SingleSelectOption, { value: "", disabled: true, children: "Select an Author" }),
              authors && authors.length > 0 ? authors.map((author2) => /* @__PURE__ */ jsx(SingleSelectOption, { value: author2.id, children: author2.name }, author2.id)) : /* @__PURE__ */ jsx(SingleSelectOption, { value: "", disabled: true, children: "No authors found" })
            ]
          }
        ),
        /* @__PURE__ */ jsx(FieldHint, { children: "Select the author of this article" })
      ] }),
      /* @__PURE__ */ jsxs(Box, { marginBottom: 4, children: [
        ...
        /* @__PURE__ */ jsxs(
          SingleSelect,
          {
            ...
            required: true,
            children: [
              /* @__PURE__ */ jsx(SingleSelectOption, { value: "", disabled: true, children: "Select a Category" }),
              categories && categories.length > 0 ? categories.map((category2) => /* @__PURE__ */ jsx(SingleSelectOption, { value: category2.id, children: category2.name }, category2.id)) : /* @__PURE__ */ jsx(SingleSelectOption, { value: "", disabled: true, children: "No categories found" })
            ]
          }
        ),
        /* @__PURE__ */ jsx(FieldHint, { children: "Select the most appropriate category for your article" })
      ] }),
      /* @__PURE__ */ jsxs(Flex, { gap: 4, justifyContent: "flex-end", paddingTop: 4, children: [
        /* @__PURE__ */ jsx(
          StyledButton,
          {
            type: "button",
            ...
            children: isSavingDraft ? /* @__PURE__ */ jsx(Loader, { small: true }) : "Save as Draft"
          }
        ),
        /* @__PURE__ */ jsx(
          StyledButton,
          {
            ...
            variant: "success",
            disabled: isSavingDraft || isSubmitting,
            children: isSubmitting ? /* @__PURE__ */ jsx(Loader, { small: true }) : "Submit"
          }
        )
      ] })
    ] }) })
...
const App = () => {
  return /* @__PURE__ */ jsxs(Routes, { children: [
    ...
    /* @__PURE__ */ jsx(Route, { path: "contributors", element: /* @__PURE__ */ jsx(ContributorsPage, {}) }),
    /* @__PURE__ */ jsx(Route, { path: "editors", element: /* @__PURE__ */ jsx(EditorsPage, {}) }),
    /* @__PURE__ */ jsx(Route, { path: "add-article", element: /* @__PURE__ */ jsx(AddArticle, {}) }),
